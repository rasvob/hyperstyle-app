    ...
    return (
        <div className="hero min-h-screen bg-gradient-to-br from-primary to-secondary">
            <div className="text-center hero-content text-neutral-content">
                <div className="">
                    <h1 className="mb-5 text-7xl font-bold animate__animated animate__zoomInLeft">
                            hyperFace
                    </h1> 
                    <div className="animate__animated animate__zoomInRight">
                        ...
                        <p> And here comes the Hyperface app for a resque because <span className="font-light">*surprise*</span> it let's you to do exactly this.</p>

                        <p>Hyperface is an app which utilizes deep learning techniques for the <span className="font-bold">style-transfer</span> of a <span className="font-bold">selfie</span> photos.</p>
